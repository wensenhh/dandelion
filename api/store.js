...
export function getHome(data) {
	return request.post('index/orderRecomList',data)
}
...
export function getAdList(data) {
	return request.post('basic/banner', {
		params: data
	});
}
...
// 商品分类
export function getCatrgory(data) {
	return request.post('product/productCategory',data);
}
