...
<style scoped>
	.tui-btn-primary-wallet {
		background: #5B9AF3 !important;
		color: #fff;
	}
	.tui-btn-primary {
	...
	.tui-btn-modal-cancel{
		background: #FFFFFF !important;
		color:#14B35B;
		
		border: 1px solid #14B35B!important;
	
	}
	.tui-btn-modal-primary{
		background: #14B35B !important;
		color: #fff;
	}
	

	.tui-shadow-modal-cancel {
		box-shadow: 0 10rpx 14rpx 0 RGBA(20, 179, 91, 1);
	}

.tui-shadow-modal-primary {
		box-shadow: 0 10rpx 14rpx 0 RGBA(20, 179, 91, 1);
	}
	.tui-shadow-primary {
	...
	.tui-shadow-warning {
		...
		.tui-shadow-primary-wallet {
		box-shadow: 0 10rpx 14rpx 0 rgba(91, 154, 243, 1);
	}
	.tui-btn-green {
		background: #F73037 !important;
		color: #fff;
	}
	.tui-btn-primary-wallet {
		background: #5B9AF3 !important;
...
.tui-bg-color{
	...
	.tui-green-outline::after {
		border: 1px solid #F73037 !important;
	}
